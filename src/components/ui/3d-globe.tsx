...
// ============================================================================
// Constants — self-contained assets (no CDN; the app must work offline)
// ============================================================================

const DEFAULT_EARTH_TEXTURE = "/textures/earth.jpg";
const DEFAULT_BUMP_TEXTURE = "/textures/earth.jpg";

/** Mean Earth radius, km — for converting geodesic km to globe units. */
...
function Marker({ marker, radius, defaultSize, onClick, onHover }: MarkerProps) {
  ...
  const tint = marker.color ?? "#ef4444";
  ...
  return (
    <group ref={groupRef} visible={isVisible}>
      ...
      <mesh position={surfacePosition} quaternion={lineQuaternion}>
        ...
        <meshBasicMaterial color={hovered ? "#ffffff" : tint} />
      </mesh>

      {/* Circular image at the top. Screen-space (no transform/distanceFactor)
          so pins keep a constant, readable size at every zoom level. */}
